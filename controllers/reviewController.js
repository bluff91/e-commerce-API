...
const createReview = async (req, res) => {
    ...
    if (alreadySubmited) {
        throw new CustomAPIError.BadRequestError("Already submited a review for this product")
    }
...
const getReview = async (req, res) => {
    ...
    if (!review) {
        throw new CustomAPIError.NotFound(`Review with Id ${req.params.id} does not exist`)
    }
